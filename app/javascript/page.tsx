...
import { javascriptQAData, searchQuestions, getTotalQuestions } from '@/app/data/javascript';
...
export default function JavaScriptPage() {
  ...
  const filteredData = searchQuery.trim() ? searchQuestions(searchQuery) : javascriptQAData;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-orange-50 to-red-100 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-40 right-40 w-48 h-48 bg-orange-200/20 rounded-full blur-2xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-10 w-20 h-20 bg-red-300/40 rounded-full blur-lg animate-pulse delay-500"></div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="flex items-center gap-4 mb-8">
          <Button
            variant="outline"
            size="sm"
            className="hover:bg-yellow-50 hover:border-yellow-300 transition-all duration-200 backdrop-blur-sm bg-white/80"
          >
            <ArrowLeft className="w-4 h-4 mr-2" />
            Quay lại
          </Button>
          <div className="backdrop-blur-sm bg-white/20 rounded-xl p-4 border border-white/30">
            <h1 className="text-3xl font-bold text-gray-800 bg-gradient-to-r from-yellow-600 to-orange-600 bg-clip-text text-transparent">
        ...
        <div className="mb-6 space-y-4">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 backdrop-blur-sm bg-white/80 border-white/30 focus:bg-white focus:border-yellow-300 transition-all duration-200"
            />
          </div>
          ...
          <div className="flex gap-2 flex-wrap">
            <Button
              ...
              size="sm"
              onClick={expandAll}
              className="backdrop-blur-sm bg-white/80 hover:bg-yellow-50 hover:border-yellow-300 transition-all duration-200"
            >
              Mở rộng tất cả
            </Button>
            <Button
            ...
            <Badge
              variant="secondary"
              className="ml-auto backdrop-blur-sm bg-gradient-to-r from-yellow-500 to-orange-500 text-white border-0"
            >
                ...
                >
                  ...
                  {isExpanded && (
                    <CardContent className="pt-0 animate-in slide-in-from-top-2 duration-300">
                      <div className="border-t pt-4 border-gradient-to-r from-yellow-200 to-orange-200">
                        <div className="prose prose-sm max-w-none">
                          ...
                          {item.codeExample && (
                            <div className="mt-4">
                              ...
                              <pre className="bg-gradient-to-r from-gray-50 to-yellow-50 p-4 rounded-xl overflow-x-auto text-sm border border-gray-200 shadow-inner">
        ...
        <div className="mt-12 text-center">
          <div className="backdrop-blur-sm bg-white/20 rounded-xl p-4 border border-white/30 inline-block">
            <p className="text-gray-700 font-medium">
              Tổng cộng <span className="text-yellow-600 font-bold">{filteredData.length}</span> câu
              hỏi được hiển thị
            </p>
          </div>
        </div>
